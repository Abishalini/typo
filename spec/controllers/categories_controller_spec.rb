...
describe Admin::CategoriesController do
  ...
  it "test_create" do
    post :new, :category => {name: 'new category', keywords: 'new category keyword', permalink: 'new category permalink', description: 'new category description'}
    assert_response :redirect, :action => 'index'
    new_category = Category.find_by_name("new category")
